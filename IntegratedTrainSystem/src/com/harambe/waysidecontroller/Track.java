			...
			if(currentBlock.isCrossing()){
				...
				if(lineCrossing == null){
					...
					lineCrossing.addBlock(currentBlock);
                                ...
                                //System.out.println("Crossing block is number: " + currentBlock.getBlockNumber());

				currentBlock.addCrossing(lineCrossing);
                                
                                //System.out.println("Block: " + currentBlock.getBlockNumber() + " has crossing " + currentBlock.getCrossing());
			}
